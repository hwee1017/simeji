...
from app.schemas.myhome.furniture import FurnitureCategory
...
class Furniture(Base):
    ...
    category = mapped_column(SQLEnum(FurnitureCategory), nullable=False, index=True)
    ...
    # Relationship
    inventory = relationship("furnitureInventory", back_populates="furniture")
